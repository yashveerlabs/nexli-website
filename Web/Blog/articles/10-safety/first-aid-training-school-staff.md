...
**Q: Is the medical data DPDP Act compliant?**
A: Nexli applies encryption and role-based access to all health records. Only authorized medical and administrative staff can access student health data.

**Q: Does Nexli integrate with external hospital or clinic systems?**
A: Nexli manages records within the school system. External hospital integration is handled through documentation (discharge summaries, referral letters) uploaded to the student's health record.

---

**Ready to manage student health records, incident tracking, and medical compliance in one place?** [Book a Free Demo](/demo)
