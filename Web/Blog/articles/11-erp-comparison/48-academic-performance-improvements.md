...
secondary_keywords:
  ...
  - "school at-risk student identification ERP"
  - "school marks analytics software"
...
## How ERP Supports Academic Performance (Indirect)
...
ERP does not teach the student. It identifies who needs help faster.

### Attendance-Performance Correlation Tracking

Research consistently shows that attendance is strongly correlated with academic performance. Students below 75% attendance are statistically at higher risk for poor exam results.

ERP tracks attendance and marks in the same system, making this correlation visible. A report showing students who are both below 75% attendance AND below subject average in multiple subjects is a targeted intervention list.
...
Before ERP: Marks are transcribed from teachers' mark sheets by clerks. Transcription errors are common and discovered only after report cards are printed.

With ERP: Teachers enter marks directly. HODs review before submission. Calculated grades are automatic. No transcription step means no transcription errors.

**The connection to performance:** Accurate marks records allow better analysis of student progress over time. If historical marks have transcription errors, trend analysis is misleading.
...
## How to Use ERP Data to Support Academic Outcomes

**Weekly at-risk review:** Run the at-risk report (students below 75% attendance OR below 60% marks in multiple subjects) weekly. Class teachers review their section's list. HODs review their department's patterns.

**Section performance comparison:** Compare average marks across sections in the same grade for the same subject. Significant differences suggest inconsistent teaching or assessment.

**Assessment-to-assessment trend:** Track whether a student's marks in a subject are improving, stable, or declining across successive assessments. A declining trend is an early warning signal.

**Attendance-marks correlation report:** Identify students where attendance decline is preceding marks decline. Early attendance intervention can prevent the marks decline.

---

## FAQ

**Q: Can ERP identify which teachers produce better learning outcomes?**
A: With caution. Section performance variation suggests differences in outcomes, but many factors affect marks beyond teaching quality (class composition, time of day, prior learning). Data should prompt inquiry, not blame.

**Q: Does NEP 2020 require ERP?**
A: NEP 2020 requires HPC tracking. Whether this happens in an ERP, a standalone system, or paper is not mandated. ERP makes it more systematic and sustainable.

**Q: How do we benchmark academic performance against other schools?**
