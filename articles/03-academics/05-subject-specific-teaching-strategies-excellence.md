...
## The Problem: Subject-Specific Teaching Strategies

Teaching methods are standardized: lecture, copy notes, memorize, exam. Works for some; fails for others. Tactile learners get frustrated. Visual learners are bored.
...
- Large achievement gaps (some students excel, others struggle)
...
1. Diversify pedagogy: storytelling, experiments, role play, debates, simulations, projects
...
- Use 80-20 rule: 80% of learning should be varied and active; only 20% passive lecture
...
A: No. Science uses experiments; English uses discussions; math uses problem-solving. Vary methods per subject and per lesson.

Q: How do we know which method works?
A: Observe engagement (Do students participate?) and assess learning (Can they apply what they learned?). Adjust if not effective.

Q: Can teachers use their preferred method exclusively?
A: Discourage it. Even the best teachers need variety. Peer observations help.

Q: How do we keep methods fresh?
A: Attend training, read education blogs, visit other schools, conduct action research. Set a goal: try 1 new method per term.
