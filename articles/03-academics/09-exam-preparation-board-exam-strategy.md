...
## The Problem: Exam Preparation and Board Exam Strategy

By November, class 12 board exam anxiety is high. Students sleep 4 hours, skip meals, withdraw from peers. Pressure from parents: "Just focus on studies."
...
- Anxiety, depression, and mental health crises
...
1. Build exam readiness gradually: not a frantic last-minute push
...
- Start exam prep in early term (Sept-Oct), not last month
...
A: Month-by-month: Jan (regular teaching, unit tests), Feb (some revision, more unit tests), Mar (serious revision), Apr-May (mock exams).

Q: Should we hire external coaching for board exams?
A: School should deliver strong teaching. External coaching fills gaps, but dependence on coaching = weak school teaching.

Q: How many mock exams should students take?
A: 3-4 mocks spaced 2-3 weeks apart: Jan, Feb, Mar. This gives time for improvement.

Q: What's a realistic board exam score range?
A: 60-70% is strong for a mixed-ability school. >75% suggests strong academics or small school size.
