...
A simple request spirals into bureaucratic chaos. Exam fee reimbursement waits weeks for approval. Room booking requests get lost. Printing orders never materialize.
...
1. Document every workflow: who initiates, who approves, timelines, escalation paths
...
- Keep workflows simple: fewer approval levels = faster processing
...
A: <10k: 24 hours | 10-50k: 3 days | >50k: 1 week. Escalate if approver is absent.

Q: Who should approve what?
A: Set thresholds: office staff <5k, HOD 5-25k, principal >25k. Publish these so requesters know.

Q: How do we handle emergency approvals?
A: Define emergencies (e.g., broken water pipe, medical need). Emergency approvals by principal with retrospective audit.

Q: How do we prevent corruption in approvals?
A: Audit trails. Rotate approvers quarterly. Never allow one person to approve and execute the same transaction.
