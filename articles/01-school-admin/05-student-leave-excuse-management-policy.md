...
## The Problem: Student Leave and Excuse Management

Student leave requests come via WhatsApp, email, verbal mentions. Staff don't know who's absent for a day or a month. Parents claim they sent leave requests.
...
- Disputes over approved vs. unapproved absences
...
1. Create a formal leave request system (online or paper template)
...
- Require leave requests 48 hours in advance (unless emergency)
...
A: Require a medical certificate for leaves >3 days or >3 times/term. Fever without exam works; fever on exam day requires doc's note.

Q: Can students appeal if leave is denied?
A: Yes. Create an appeals process: if parent disagrees with denial, escalate to principal. Be transparent about criteria.

Q: What if a student's leave crosses exam dates?
A: Strict rule: no leave 1 week before exams. If genuine emergency, student takes exam with makeup/adjustment.

Q: How do we handle exeat (weekend leave) in boarding schools?
A: Track exeat requests, approvals, and returns. Penalize unauthorized exeat (loss of next exeat, fine, or other discipline).
