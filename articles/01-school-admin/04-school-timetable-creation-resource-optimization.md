...
## The Problem: School Timetable Creation

Creating a school timetable manually is chaotic: balancing teacher availability, classroom availability, student core/elective combinations, lab sessions,
...
- Teachers teach 6+ hours (exceeding legal limits) while other classes are under-utilized
...
1. Map all constraints: teacher availability, room capacity, co-curricular slots
...
- Involve department heads in defining constraints early
...
A: 35-40 students is manageable for one teacher. Smaller classes (25) allow more differentiation; larger (45+) strain resources.

Q: Can we use AI to create timetables?
A: Yes. Tools like Untis and TimeEdit use algorithms. But input data quality matters: if teacher availability is wrong, output will be wrong.

Q: How do we handle teacher absences mid-year?
A: Build 5% flexibility into the timetable (have backup teachers or planned gaps) for unexpected absences.

Q: Should specialist subjects (art, music) have set timeslots or vary per week?
A: Set timeslots (e.g., art always Wednesday 2-3 PM) help students remember and parents plan.
